...
class ParametroValidatorTest {
    ...
    private GrupoValidacaoDTO grupo;
    ...
    void setUp() {
        ...
        grupo = new GrupoValidacaoDTO(
                "ANALISE_CREDITO_PESSOAL", "Teste", true, params,
                List.of(new ValidacaoDefinicaoDTO(
                        201, "teste", "desc", "PK_TEST.PROC",
                        TipoValidacao.LEITURA, 5000, true, false, List.of()
                ))
        );
    }
    ...
    void valoresPermitidos() {
        ...
        var grupoComPermitidos = new GrupoValidacaoDTO(
