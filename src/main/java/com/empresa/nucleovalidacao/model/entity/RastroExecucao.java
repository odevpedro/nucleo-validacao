...
@Entity
@Table(name = "RASTRO_EXECUCAO", schema = "BANK_CORE")
public class RastroExecucao {
    ...
    @Column(name = "ID_EXECUCAO_DEF", nullable = false)
    private Integer idExecucaoDef;

    @Column(name = "NOME_EXECUCAO", nullable = false, length = 150)
    private String nomeExecucao;
    ...
    public Integer getIdExecucaoDef() { return idExecucaoDef; }
    public void setIdExecucaoDef(Integer idExecucaoDef) { this.idExecucaoDef = idExecucaoDef; }
    public String getNomeExecucao() { return nomeExecucao; }
    public void setNomeExecucao(String nomeExecucao) { this.nomeExecucao = nomeExecucao; }
