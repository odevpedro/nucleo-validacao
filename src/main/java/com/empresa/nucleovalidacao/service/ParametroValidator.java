...
import com.empresa.nucleovalidacao.model.dto.ParametroDefinicaoDTO;
...
public class ParametroValidator {
    ...
    public List<ErroValidacaoDTO> validar(GrupoValidacaoDTO grupo, Map<String, Object> parametros) {
